...
This repository contains Dockerfiles for [Alpine](https://www.alpinelinux.org) 3.20 - 3.24 for automatic image rebuild with the latest packages installed. The resulting images are usually bigger than base images but more secure.
...
docker pull ghcr.io/essentialkaos/alpine:3.24
```
...
docker pull essentialkaos/alpine:3.24
```
